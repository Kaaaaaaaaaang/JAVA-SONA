...
public class MemberShipPay extends JFrame{
	...
	public MemberShipPay() {
		...
		String str=Pay.time+"시간   "+Integer.toString(Pay.price)+"\\";
		howmuch.setText(str);
		...
		if(user.getMem_money()!=0) {
			...
			money.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					try {
						if(db.minusmoney(Pay.price)==true) {
							dispose(); reserve.Receipt r=new reserve.Receipt(); r.setVisible(true);
